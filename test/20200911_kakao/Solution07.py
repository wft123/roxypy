...
def solution(sales, links):
    ...
    for link in links:
        teams[link[0]] = teams.get(link[0]).union(link) if teams.get(link[0]) else set(link)
...
s1 = [14, 17, 15, 18, 19, 14, 13, 16, 28, 17]
l1 = [[10, 8], [1, 9], [9, 7], [5, 4], [1, 5], [5, 10], [10, 6], [1, 3], [10, 2]]

print(solution(s1, l1))

#print(set([1, 2, 3]).union([4, 5]))
